...
export const otpVerify = async (otp: any): Promise<ResponseType> => {
  try {
...
export const loginUser = async (credentials: any): Promise<ResponseType> => {
  try {
...
export const forgetPassword = async (email: any): Promise<ResponseType> => {
  try {
...
export const resetPassword = async (details: any): Promise<ResponseType> => {
  try {
